...
const articles = [
  {
    ...
    description: "Explore the critical aspects of data protection, privacy laws, and best practices for securing sensitive information in today's interconnected world.",
    category: "Cybersecurity",
    date: "Sep 13, 2024",
    readTime: "6 min read",
    image: "/data-protection.jpg",
    url: "https://medium.com/@gamikapunsisi/data-protection-in-the-digital-age-770cb472a9aa"
  },
  {
    id: 2,
    title: "Understanding Supervised, Unsupervised, and Reinforcement Learning",
    description: "A breakdown of the main types of machine learning—supervised, unsupervised, and reinforcement—and their real-world applications.",
    category: "Machine Learning",
    date: "Jul 26, 2024",
    readTime: "2 min read",
    image: "/ml-types.png",
    url: "https://medium.com/@gamikapunsisi/unlocking-machine-learning-understanding-supervised-unsupervised-and-reinforcement-learning-85ab078d8b5c"
  }
]
    ...
    <section id="blog" className="py-20 bg-background/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link
            href="https://medium.com/@gamikapunsisi"
            target="_blank"
            rel="noopener noreferrer"
